        ...
        protected override void OnKeyPress(KeyEventArgs e)
        {
            ...
            if (!e.Handled)
            {
                ...
                if (e.Key == Keys.Up)
                {
                    ...
                    if (e.Shift && selection.IsEmpty && mode != TextBoxMode.Password) selection.Start = Pos;
                    if (!e.Control) PosY -= 1;
                }
                ...
                else if (e.Key == Keys.Left)
                {
                    ...
                    if (e.Shift && selection.IsEmpty && mode != TextBoxMode.Password) selection.Start = Pos;
                    if (!e.Control) Pos -= 1;
                    if (e.Control) Pos = FindPrevWord(shownText);
                }
                else if (e.Key == Keys.Right)
                {
                    ...
                    if (e.Shift && selection.IsEmpty && mode != TextBoxMode.Password) selection.Start = Pos;
                    if (!e.Control) Pos += 1;
                    if (e.Control) Pos = FindNextWord(shownText);
                }
                ...
                else if (e.Key == Keys.End)
                {
                    e.Handled = true;
                    if (e.Shift && selection.IsEmpty && mode != TextBoxMode.Password) selection.Start = Pos;
                    if (!e.Control) PosX = Lines[PosY].Length;
                    if (e.Control) Pos = Text.Length;
                }
                else if (e.Key == Keys.PageUp)
                {
                    e.Handled = true;
                    if (e.Shift && selection.IsEmpty && mode != TextBoxMode.Password) selection.Start = Pos;
                    if (!e.Control) PosY -= linesDrawn;
                }
