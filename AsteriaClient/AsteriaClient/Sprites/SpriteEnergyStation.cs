...
{
    public class SpriteEnergyStation : SpriteUnit
    {
        #region Fields
        ...
        #region Constructors
        public SpriteEnergyStation(EnergyStation entity, Texture2D texture)
            : base(entity, texture)
        {
        ...
        public override void Update(GameTime gameTime, Context context)
        {
            ...
            foreach (int entityId in ((EnergyStation)entity).Connections)
            {
            ...
            {
                if (((EnergyStation)entity).Connections.Contains(kvp.Key.Id) && context.ZoneManager.GetEntity(kvp.Key.Id) != null)
